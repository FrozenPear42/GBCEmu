...
/*
    uint8_t mBIOS[256] = {
            0x00, 0x31, 0xFE, 0xFF, 0x00, 0xFB, 0x3E, 0x01, 0xE0, 0xFF, 0x3E, 0x10, 0xE0, 0x41, 0x3E, 0xCD,
            0xB9, 0x20, 0xF8, 0x2E, 0xAB, 0x76, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x0E, 0xCD, 0xD9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    };
*/

/*
    uint8_t mBIOS[256] = {
            ,
    };
*/
    ...
    bool mStartup = true;
    std::vector<std::function<void(uint16_t, uint8_t)> > mIOCallbacks;
    std::vector<std::function<void(uint16_t, uint8_t*)> > mVRAMCallbacks;
...
public:
    ...
    void writeByte(uint16_t pAddr, uint8_t pValue, bool pSilent = false);

    void writeWordLS(uint16_t pAddr, uint16_t pValue);

    void subscribeIO(std::function<void(uint16_t, uint8_t)> pCallback);

    void unsubscribeIO(std::function<void(uint16_t, uint8_t)> pCallback);

    void subscribeVRAM(std::function<void(uint16_t, uint8_t*)> pCallback);

    void unsubscribeVRAM(std::function<void(uint16_t, uint8_t*)> pCallback);
